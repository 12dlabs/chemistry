...
function register(element: Element) {
    if (!element || !(element instanceof Element) || element.number < 1) return;
    if (element.number <= table.length) {
        table[element.number - 1] = element;
        return;
    }

    let i = others.findIndex(ele => ele.number === element.number);
    if (i < 0) others.push(element);
    else others[i] = element;
}
 ...
 */
export function getElement(element: string | number) {
    if (!element) {
        return undefined;
    }
    ...
    if (typeof element === "number") {
        ...
        let r = others.find(ele => ele.number === element);
        if (r) return r;
        if (element > Number.MAX_SAFE_INTEGER)
            return undefined;
        r = new Element(element, null, null);
        register(r);
        return r;
    }

    if (typeof element == "string") {
        return table.find(ele => ele.symbol === element);
    }
 ...
 */
 class PeriodicTable {
     ...
     * @returns The chemical element.
     */
    public get(element: string | number) {
     ...
     * @param element The element symbol or atomic number.
     */
    public exist(element: string | number | Element) {
        if (!element) return false;
        if (element instanceof Element)
            return table.findIndex(ele => ele === element) >= 0
                || others.findIndex(ele => ele === element) >= 0;
        if (typeof element === "number")
            return table.findIndex(ele => ele && ele.number === element) >= 0
                || others.findIndex(ele => ele && ele.number === element) >= 0;
        if (typeof element === "string")
            return table.findIndex(ele => ele && ele.symbol === element) >= 0
                || others.findIndex(ele => ele && ele.symbol === element) >= 0;
        return false;
    }
     ...
     */
    public filter(predicate: (ele: Element, index: number, array: Element[]) => boolean, thisArg?: any) {
        return [...table, ...others].filter(predicate, thisArg);
    }
     ...
     */
    public find(predicate: (ele: Element, index: number, array: Element[]) => boolean, thisArg?: any) {
        return [...table, ...others].find(predicate, thisArg);
    }
...
export const Table = new PeriodicTable();

function init() {
    table = [
        new Element(1, "H", "Hydrogen", { weight: 1.008, isotopes: [1.00782503223,2.01410177812,3.0160492779,4.02643,5.035311,6.04496,7.0527] }),
        new Element(2, "He", "Helium", { weight: 4.002602, isotopes: [3.0160293201,4.00260325413,5.012057,6.018885891,7.0279907,8.03393439,9.043946,10.05279] }),
        new Element(3, "Li", "Lithium", { weight: 6.94, isotopes: [3.0308,4.02719,5.012538,6.0151228874,7.0160034366,8.022486246,9.02679019,10.035483,11.04372358,12.052517,13.06263] }),
        new Element(4, "Be", "Beryllium", { weight: 9.0121831, isotopes: [5.0399,6.0197264,7.016928717,8.005305102,9.012183065,10.013534695,11.02166108,12.0269221,13.036135,14.04289,15.05342,16.06167] }),
        new Element(5, "B", "Boron", { weight: 10.81, isotopes: [6.0508,7.029712,8.0246073,9.01332965,10.01293695,11.00930536,12.0143527,13.0177802,14.025404,15.031088,16.039842,17.04699,18.05566,19.0631,20.07207,21.08129] }),
        new Element(6, "C", "Carbon", { weight: 12.011, isotopes: [8.037643,9.0310372,10.01685331,11.0114336,12,13.00335483507,14.0032419884,15.01059926,16.0147013,17.022577,18.026751,19.0348,20.04032,21.049,22.05753,23.0689] }),
        new Element(7, "N", "Nitrogen", { weight: 14.007, isotopes: [10.04165,11.026091,12.0186132,13.00573861,14.00307400443,15.00010889888,16.0061019,17.008449,18.014078,19.017022,20.023366,21.02711,22.03439,23.04114,24.05039,25.0601] }),
        new Element(8, "O", "Oxygen", { weight: 15.999, isotopes: [12.034262,13.024815,14.00859636,15.00306562,15.99491461957,16.9991317565,17.99915961286,19.003578,20.00407535,21.008655,22.009966,23.015696,24.01986,25.02936,26.03729,27.04772,28.05591] }),
        new Element(20, "Ca", "Calcium", { weight: 40.078, isotopes: [34.01487,35.00514,35.993074,36.98589785,37.97631922,38.97071081,39.962590863,40.96227792,41.95861783,42.95876644,43.95548156,44.95618635,45.953689,46.9545424,47.95252276,48.95566274,49.9574992,50.960989,51.963217,52.96945,53.9734,54.9803,55.98508,56.99262,57.99794] }),
        ...
        new Element(58, "Ce", "Cerium", { weight: 140.116, isotopes: [118.95271,119.94654,120.94335,121.93787,122.93528,123.93031,124.92844,125.923971,126.922727,127.918911,128.918102,129.914736,130.914429,131.911464,132.91152,133.908928,134.909161,135.90712921,136.90776236,137.905991,138.9066551,139.9054431,140.9082807,141.9092504,142.9123921,143.9136529,144.917265,145.918802,146.9226899,147.924424,148.928427,149.930384,150.934272,151.9366,152.94093,153.9438,154.94855,155.95183,156.95705] }),
        new Element(59, "Pr", "Praseodymium", { weight: 140.90766, isotopes: [120.95532,121.95175,122.94596,123.94294,124.9377,125.93524,126.93071,127.928791,128.925095,129.92359,130.920235,131.919255,132.916331,133.915697,134.913112,135.912677,136.9106792,137.910754,138.9089408,139.9090803,140.9076576,141.9100496,142.9108228,143.9133109,144.9145182,145.91768,146.919008,147.92213,148.923736,149.9266765,150.928309,151.931553,152.933904,153.93753,154.940509,155.94464,156.94789,157.95241,158.95589] }),
        ...
        new Element(94, "Pu", "Plutonium", { weight: 244, isotopes: [228.038732,229.040144,230.03965,231.041102,232.041185,233.042998,234.0433174,235.045286,236.0460581,237.0484098,238.0495601,239.0521636,240.0538138,241.0568517,242.0587428,243.0620036,244.0642053,245.067826,246.070205,247.07419] }),
        new Element(95, "Am", "Americium", { weight: 243, isotopes: [230.04609,231.04556,232.04645,233.04644,234.04773,235.047908,236.04943,237.049996,238.051985,239.0530247,240.0553,241.0568293,242.0595494,243.0613813,244.0642851,245.0664548,246.069775,247.07209,248.07575,249.07848] }),
        new Element(96, "Cm", "Curium", { weight: 247, isotopes: [232.04982,233.05077,234.05016,235.05154,236.051374,237.052869,238.053081,239.05491,240.0555297,241.0576532,242.058836,243.0613893,244.0627528,245.0654915,246.0672238,247.0703541,248.0723499,249.0759548,250.078358,251.082286,252.08487] }),
        new Element(97, "Bk", "Berkelium", { weight: 247, isotopes: [234.05727,235.05658,236.05748,237.0571,238.0582,239.05824,240.05976,241.06016,242.06198,243.0630078,244.065181,245.0663618,246.068673,247.0703073,248.073088,249.0749877,250.0783167,251.080762,252.08431,253.08688,254.0906] }),
        new Element(98, "Cf", "Californium", { weight: 251, isotopes: [237.062198,238.06149,239.06253,240.062256,241.06369,242.063754,243.06548,244.0660008,245.0680487,246.0688055,247.070965,248.0721851,249.0748539,250.0764062,251.0795886,252.0816272,253.0851345,254.087324,255.09105,256.09344] }),
        new Element(99, "Es", "Einsteinium", { weight: 252, isotopes: [239.06823,240.06892,241.06856,242.06957,243.06951,244.07088,245.07125,246.0729,247.073622,248.075471,249.076411,250.07861,251.0799936,252.08298,253.0848257,254.0880222,255.090275,256.0936,257.09598,258.09952] }),
        new Element(100, "Fm", "Fermium", { weight: 257, isotopes: [241.07421,242.07343,243.07446,244.07404,245.07535,246.07535,247.07694,248.0771865,249.0789275,250.079521,251.08154,252.0824671,253.0851846,254.0868544,255.089964,256.0917745,257.0951061,258.09708,259.1006,260.10281] }),
        new Element(101, "Md", "Mendelevium", { weight: 258, isotopes: [245.08081,246.08171,247.08152,248.08282,249.08291,250.08441,251.084774,252.08643,253.087144,254.08959,255.0910841,256.09389,257.0955424,258.0984315,259.10051,260.10365,261.10583,262.1091] }),
        new Element(102, "No", "Nobelium", { weight: 259, isotopes: [248.08655,249.0878,250.08756,251.08894,252.088967,253.0905641,254.090956,255.093191,256.0942829,257.0968878,258.09821,259.10103,260.10264,261.1057,262.10746,263.11071,264.11273] }),
        new Element(103, "Lr", "Lawrencium", { weight: 266, isotopes: [251.09418,252.09526,253.09509,254.09648,255.096562,256.098494,257.099418,258.10176,259.102902,260.1055,261.10688,262.10961,263.11136,264.1142,265.11619,266.11983] }),
        new Element(104, "Rf", "Rutherfordium", { weight: 267, isotopes: [253.10044,254.10005,255.10127,256.101152,257.102918,258.103428,259.105596,260.10644,261.108773,262.10992,263.11249,264.11388,265.11668,266.11817,267.12179,268.12397] }),
        new Element(105, "Db", "Dubnium", { weight: 268, isotopes: [255.10707,256.10789,257.10758,258.10928,259.109492,260.1113,261.11192,262.11407,263.11499,264.11741,265.11861,266.12103,267.12247,268.12567,269.12791,270.13136] }),
        new Element(106, "Sg", "Seaborgium", { weight: 269, isotopes: [258.11298,259.1144,260.114384,261.115949,262.116337,263.11829,264.11893,265.12109,266.12198,267.12436,268.12539,269.12863,270.13043,271.13393,272.13589,273.13958] }),
        new Element(107, "Bh", "Bohrium", { weight: 270, isotopes: [260.12166,261.12145,262.12297,263.12292,264.12459,265.12491,266.12679,267.1275,268.12969,269.13042,270.13336,271.13526,272.13826,273.14024,274.14355,275.14567] }),
        new Element(108, "Hs", "Hassium", { weight: 270, isotopes: [263.12852,264.128357,265.129793,266.130046,267.13167,268.13186,269.13375,270.13429,271.13717,272.1385,273.14168,274.1433,275.14667,276.14846,277.1519] }),
        new Element(109, "Mt", "Meitnerium", { weight: 278, isotopes: [265.136,266.13737,267.13719,268.13865,269.13882,270.14033,271.14074,272.14341,273.1444,274.14724,275.14882,276.15159,277.15327,278.15631,279.15808] }),
        new Element(110, "Ds", "Darmstadtium", { weight: 281, isotopes: [267.14377,268.14348,269.144752,270.144584,271.14595,272.14602,273.14856,274.14941,275.15203,276.15303,277.15591,278.15704,279.1601,280.16131,281.16451] }),
        new Element(111, "Rg", "Roentgenium", { weight: 282, isotopes: [272.15327,273.15313,274.15525,275.15594,276.15833,277.15907,278.16149,279.16272,280.16514,281.16636,282.16912,283.17054] }),
        new Element(112, "Cn", "Copernicium", { weight: 285, isotopes: [276.16141,277.16364,278.16416,279.16654,280.16715,281.16975,282.1705,283.17327,284.17416,285.17712] }),
        new Element(113, "Nh", "Nihonium", { weight: 286, isotopes: [278.17058,279.17095,280.17293,281.17348,282.17567,283.17657,284.17873,285.17973,286.18221,287.18339] }),
        new Element(114, "Fl", "Flerovium", { weight: 289, isotopes: [285.18364,286.18423,287.18678,288.18757,289.19042] }),
        new Element(115, "Mc", "Moscovium", { weight: 290, isotopes: [287.1907,288.19274,289.19363,290.19598,291.19707] }),
        new Element(116, "Lv", "Livermorium", { weight: 293, isotopes: [289.19816,290.19864,291.20108,292.20174,293.20449] }),
        new Element(117, "Ts", "Tennessine", { weight: 294, isotopes: [291.20553,292.20746,293.20824,294.21046] }),
        new Element(118, "Og", "Oganesson", { weight: 294, isotopes: [293.21356,294.21392,295.21624] })    ];
}
init();
